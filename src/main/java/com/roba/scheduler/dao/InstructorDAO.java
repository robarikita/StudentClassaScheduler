...
public class InstructorDAO {
    ...
    public boolean addInstructor(Instructor instructor) {
        String sql = "INSERT INTO instructors (user_id, first_name, last_name, email, department, office_number, phone, max_courses_per_semester) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            stmt.setString(6, instructor.getOfficeNumber());
            stmt.setString(7, instructor.getPhone());
            stmt.setInt(8, instructor.getMaxCoursesPerSemester());
